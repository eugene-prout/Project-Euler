lst_ = [[8, 2, 22, 97, 38, 15, 00, 40, 00, 75, 4, 5, 7, 78, 52, 12, 50, 77, 91, 8],
        [49, 49, 99, 40, 17, 81, 18, 57, 60, 87,
            17, 40, 98, 43, 69, 48, 4, 56, 62, 00],
...
for row in range(0, 19):
    for column in range(0, 19):
        ...
        # Check Down
        if row < 17:
            num1 = lst_[row][column]
            num2 = lst_[row+1][column]
            num3 = lst_[row+2][column]
            num4 = lst_[row+3][column]
        ...
        if column > 2:
            num1 = lst_[row][column]
            num2 = lst_[row][column-1]
            num3 = lst_[row][column-2]
            num4 = lst_[row][column-3]
        ...
        if row < 17 and column < 17:
            num1 = lst_[row][column]
            num2 = lst_[row+1][column+1]
            num3 = lst_[row+2][column+2]
            num4 = lst_[row+3][column+3]
